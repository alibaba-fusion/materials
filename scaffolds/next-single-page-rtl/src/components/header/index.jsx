...
class Header extends Component {
  ...
  footer() {
    ...
    return (<div>
      <Switch style={{verticalAlign: 'middle', margin: '0 10px', width: '60px'}} checked={rtl} checkedChildren="RTL" onChange={changeDir} unCheckedChildren="LTR" />
      <Select dataSource={langSource} value={locale} onChange={changeLang}/>
