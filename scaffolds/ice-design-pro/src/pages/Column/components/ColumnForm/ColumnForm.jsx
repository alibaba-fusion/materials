...
import { Input, Button, Select, Grid, Form, SplitButton } from '@alifd/next';
            ...
            <div>
              <Row wrap>
                <Col xxs="24" s="12" l="12">
                  <FormItem label="合同编号：" {...formItemLayout} required requiredMessage="合同编号必须填写">
                    <Input name="contractId" />
                  </FormItem>
                  <FormItem label="签约运营商：" {...formItemLayout} required requiredMessage="签约运营商必须填写">
                    <Input name="operator" />
                  </FormItem>
                  <FormItem label="计费周期：" {...formItemLayout} required requiredMessage="请选择计费周期">
                    <Select
                      name="period"
                      style={{ width: '100%' }}
                      dataSource={[
                ...
                <Col xxs="24" s="12" l="12">
                  <FormItem label="结算运营商：" {...formItemLayout} required requiredMessage="结算运营商必须填写">
