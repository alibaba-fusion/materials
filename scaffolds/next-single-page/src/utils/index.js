 ...
 * @param {String} str
 */
export const varCase = str => str.replace(/-[a-z]/g, m => m[1].toUpperCase()).replace(/^.{1}/, m => m.toUpperCase());
/**
 * AbcXyz => abc-xyz
 * @param {String} str
 */
export const lowCase = str => str.replace(/[A-Z]/g, m => `-${m.toLowerCase()}`).replace(/^-/, '');
/**
