  ...
  render() {
    return (
      <div className={styles.helpeCenter}>
        <Menu className={styles.menu} selectMode="single" selectedKeys={this.state.selectedKeys} onSelect={this.handleSelect}>
          <Group label="新手指南">
        ...
        <Card className={styles.card} title={mockData[this.state.selectedKeys].question} contentHeight='auto'>
