...
// 修改一个区块添加一个检测
const blocks = ['ActionTable','AdvancedDetail','BasicDetail','BasicForm','BasicList','CardList','FlowForm', 'Forbidden', 'FourColumnForm','FusionCardLineChart','FusionCardPieChart','FusionCardRankChart'];
