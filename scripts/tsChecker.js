...
// 修改一个区块添加一个检测
const blocks = ['ActionTable','AdvancedDetail','BasicDetail','BasicForm','BasicList','CardList','FlowForm','Forbidden','FourColumnForm','SingleTreeTable','StepForm','SuccessDetail','SettingPersonBlock','SettingSystemBlock','SingleColFilterTable','FlowForm', 'Forbidden', 'FourColumnForm','PageHeader', 'RegisterBlock', 'ServerError','ExpandTable','FailDetail','FilterTable','FusionCardAreaChart','FusionCardBarChart','FusionCardGroupBarChart'];
